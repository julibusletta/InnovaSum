...
export default function CategoriesPage() {
  ...
  if (loading) return <div className="p-20 text-center animate-pulse text-gray-400 font-bold uppercase tracking-widest text-lg">Cargando taxonomía...</div>;
    ...
    <div className="animate-fadeIn pb-20">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="px-6 py-3 bg-[#058c8c] text-white rounded shadow-xl text-lg font-black uppercase tracking-widest hover:scale-105 transition-transform flex items-center gap-2"
          >
      ...
      <div className="admin-v2-card p-8 mb-10 border-l-4 border-l-[#058c8c] bg-[#058c8c]/[0.02]">
         <div className="flex gap-6 items-start">
            ...
            <div>
               <h3 className="text-lg font-black text-gray-900 uppercase tracking-widest mb-2">Organización del Menú</h3>
               <p className="text-base text-gray-500 leading-relaxed max-w-2xl font-medium">
              ...
              <div key={cat.id} className="admin-v2-card group overflow-hidden border border-gray-100 p-6">
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-400 font-bold uppercase tracking-widest mt-1">Slug: {cat.slug}</p>
                            <div className="mt-2 bg-gray-100 text-gray-600 px-2 py-0.5 rounded text-base font-black uppercase tracking-widest inline-block shadow-sm">
                 ...
                 {subcategories.length > 0 && (
                     <div className="mt-6 ml-24 pl-6 border-l-2 border-gray-100 space-y-4">
                         <h4 className="text-base font-black text-gray-400 uppercase tracking-widest mb-4">Subcategorías</h4>
                            ...
                            <div key={sub.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-transparent hover:border-[#058c8c]/20 transition-all">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-400 uppercase tracking-widest">Slug: {sub.slug}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="bg-white text-gray-500 border border-gray-100 px-2 py-0.5 rounded text-base font-black uppercase tracking-widest shadow-sm">
        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-gray-900/60 backdrop-blur-md animate-fadeIn">
           <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-slideDown border border-gray-100 max-h-[90vh] flex flex-col">
              ...
              <div className="p-8 space-y-6 overflow-y-auto flex-1">
                 <div>
                    <label className="block text-lg font-black text-gray-500 uppercase tracking-widest mb-2">Nombre</label>
                    <input 
                        type="text"
                        ...
                        className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg outline-none text-lg font-bold focus:border-[#058c8c] transition-all"
                        placeholder="Ej: Auriculares"
                    />
                 </div>

                 <div>
                    <label className="block text-lg font-black text-gray-500 uppercase tracking-widest mb-2">Slug (URL)</label>
                    <input 
                        type="text"
                        ...
                        placeholder="Ej: auriculares"
                    />
                    <p className="text-base text-gray-400 mt-1 uppercase tracking-widest">Identificador único en minúsculas y sin espacios.</p>
                 </div>

                 <div>
                    <label className="block text-lg font-black text-gray-500 uppercase tracking-widest mb-2">Categoría Padre (Opcional)</label>
                    <select
                        value={editingCategory.parentId || ''}
                        onChange={e => setEditingCategory({...editingCategory, parentId: e.target.value})}
                        className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg outline-none text-lg font-bold text-gray-700 focus:border-[#058c8c] transition-all cursor-pointer"
                    >
                    ...
                    <p className="text-base text-gray-400 mt-1 uppercase tracking-widest">Seleccioná si esta es una subcategoría.</p>
                 </div>
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <input 
                                ...
                                className="w-full mt-2 px-3 py-2 bg-white border border-gray-200 rounded outline-none text-base text-gray-500 focus:border-[#058c8c] transition-all"
                 ...
                 <div>
                    <label className="block text-lg font-black text-gray-500 uppercase tracking-widest mb-2">Descripción (Opcional)</label>
                    <textarea 
                        value={editingCategory.description || ''}
                        onChange={e => setEditingCategory({...editingCategory, description: e.target.value})}
                        className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg outline-none text-lg text-gray-700 focus:border-[#058c8c] transition-all resize-none h-20"
              ...
              <div className="p-6 border-t border-gray-100 flex gap-4 bg-gray-50/50">
                 <button 
                  ...
                  className="flex-1 py-3 text-base font-black text-gray-500 uppercase tracking-widest hover:text-gray-800 transition active:scale-95 bg-white border border-gray-200 rounded-xl shadow-sm"
                 >
                    Cancelar
                 </button>
                 <button 
                  ...
                  disabled={isSaving}
                  className="flex-1 py-3 bg-[#058c8c] text-white rounded-xl text-base font-black uppercase tracking-widest shadow-xl shadow-[#058c8c]/30 hover:bg-[#047a7a] hover:scale-[1.02] transition-all transform active:scale-95 disabled:opacity-50"
                 >
