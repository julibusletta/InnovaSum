...
export default function Footer() {
  return (
    <>
      <footer id="footer" className="w-full bg-[#001a3d] text-white py-16 md:py-20 px-4 md:px-16">
            ...
            <div className="flex flex-wrap gap-6 md:gap-8 mb-5">
              ...
              <div className="flex-1 min-w-56">
                ...
                <div className="flex gap-2.5 mt-4" id="socialiconfooter">
                  ...
                  <a
                    href="https://wa.me/5491130535973"
                    target="_blank"
                    rel="noopener noreferrer"
